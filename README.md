...
Your need to implement the `process` method in the [Solver.php](src/Solver.php) class.

All the unit tests in [TexasHoldemSolverTest.php](tests/TexasHoldemSolverTest.php), [OmahaHoldemSolverTest.php](tests/OmahaHoldemSolverTest.php), and
[FiveCardDrawSolverTest.php](tests/FiveCardDrawSolverTest.php) should pass. There will also be other tests run after you submit your solver. 
